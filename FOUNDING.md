# LocalRegister 3214 — Founding Governance Document
...
**1. The Register Belongs to the Community**
LocalRegister is community-owned infrastructure. It is not owned by any individual, organisation, political party, or government body. Every resident of 3214 has equal standing as a contributor and reader. No single person or group may claim ownership, control access, or act as the definitive authority on what the register contains.

**2. Nothing in the Register Is Ever Deleted**
Once an entry is in the register, it cannot be removed. An editor may mark an entry as a duplicate, out of scope, or contested — but the original entry remains visible in the public record. This is the most important single rule. It is what makes the register a genuine record rather than a curated narrative. Deletion is not an editor power under any circumstances.
...
**4. All Editorial Decisions Are Publicly Logged**
Every action taken by an editor — elevating an issue to highlighted or pinned tier, marking an entry as a duplicate, writing a digest summary — is recorded in the version history with a timestamp and the editor's name. Editors are accountable to the community through visibility, not through hierarchy. The edit history is the accountability mechanism.

**5. Editors Are Custodians, Not Gatekeepers**
Editors maintain the infrastructure through which the community's voice passes. They do not judge which concerns are legitimate. They do not filter based on their own views. They do not decide what matters. The community decides legitimacy through submissions and upvotes. Editors ensure the system functions correctly. A librarian does not decide which books are worth reading. LocalRegister's editors are librarians.

**6. The Register Is Pre-Political**
LocalRegister records what is happening in 3214 before political interpretation begins. A pollution spike at 11pm is a fact. A demand for a specific policy response is a political position. The register contains the first kind of statement. It does not take the second kind of position. This neutrality is what makes the register credible to all residents regardless of political affiliation. It must be actively protected.

**7. Open Source and Publicly Readable**
The code, the structure, and all data in LocalRegister are publicly available. Any resident can read any entry without creating an account. Any community anywhere can fork the code and run their own instance. No login is required to access the record. Transparency is not a feature — it is the foundation.

**8. The Register Persists Beyond Any Individual or Group**
LocalRegister is designed to outlast any founding member, any steward, and any group that currently uses it. If all current editors step back, the record remains. If one group fades, or another goes quiet, or any group disbands, their entries remain in the register. The record belongs to 3214, not to whoever is currently maintaining it.
...
- **Title** — plain language, one sentence describing the concern
- **Date first raised** — when the resident first experienced or raised this issue
- **Description** — the resident's own account, in their own words
- **Geography** — suburb, neighbourhood, and optionally street level
- **Jurisdiction** — Local, State, Federal, or Cross-jurisdictional (multi-select)
- **Issue type** — Environment, Housing, Health & Wellbeing, Food Security, Safety, Infrastructure, Governance (multi-select)
- **Evidence** — Community report, Sensor data, FOI result, Media, Official document (multi-select)
- **Attribution** — resident's name, or "A 3214 resident" if anonymous

### What Cannot Be Done to Register Entries

- No entry may be deleted from the register under any circumstances.
- No entry may be edited by anyone other than the original submitter, within 48 hours of submission, for the purpose of correcting factual errors in their own submission.
- No entry may be reworded, summarised, or paraphrased by an editor to change its meaning.
- No entry may be hidden, archived, or made less visible as a consequence of editorial disagreement with its content.
...
- **The fact that the conversation occurred, who was involved, what it concerned, and what commitment or decision resulted** may be entered into the register, even without the consent of the official or body involved, and even where the conversation was conducted privately.
- **The exact private wording of what was said**, and the privacy of any other resident or private individual involved, remain protected wherever possible. The register records the outcome, not a transcript, unless the substance cannot be accurately conveyed without it.
- The standard applied is whether withholding the fact primarily protects the public, or primarily protects the person or body holding power from accountability for how that power was used.
...
- Delete any entry from the register
- Edit another contributor's entry beyond correcting technical errors
- Suppress or hide any entry based on disagreement with its content
- Represent LocalRegister publicly as advocating for a specific political position
- Accept funding from any political party or government body without community approval
- Change the Founding Principles without following the amendment process
- Act as the sole decision-maker on any consequential editorial question
...
*— The Founding Community of LocalRegister 3214*
*3214.localregister.org*
